...
<body>
    ...
    <div class="container mt-5">
        <div class="">
            <h2 class="mb-4 ">Ethiopian Water resource Management</h2>
        </div>

        <div class="col-6 align-center " style="display:block;">
            <form action="{{ route('searchCustomer') }}" method="post">
                @csrf
                
                <div class="form-group">
                    <label for="deposite">Device Number</label>
                    <input type="text" class="form-control col-6" id="deposite" name="deviceNumber" placeholder="Enter amount">
                    <small id="depositeHelp" class="form-text text-muted">Type your device number </small>
                  </div>
